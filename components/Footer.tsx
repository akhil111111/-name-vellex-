    ...
    <footer className="bg-gray-900 text-white pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            <h3 className="text-xl font-bold mb-4">VELLEX</h3>
            <p className="text-gray-400 mb-4">
              Your destination for modern fashion essentials designed with quality and style in mind.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/categories/kids" className="text-gray-400 hover:text-white transition-colors">
                  Kids' Clothing
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/order-tracking" className="text-gray-400 hover:text-white transition-colors">
                  Order Tracking
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              &copy; {new Date().getFullYear()} Vellex. All rights reserved.
            </p>
